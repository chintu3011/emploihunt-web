...
<body>
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container backgrouncnt"> 
        
        <div class="row justify-content-center">
            <span  class="privacypolicyimg">
        
        <img  src="images/personal-information-file-6-svgrepo-com.svg"  onclick="window.open('terms and condition.html', '_blank')">
        </span>
            
        <div class="col-lg-4 col-md-6 card cardbg"> 
                   
        
                 
                    <!-- // echo $dataArray['data'][1]['tDesc'];  -->
        ...
        $url = "https://api.emploihunt.com/api/jobSeeker/get_jobSeeker?current_page=1";
        $ch = curl_init();
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Job Seekers</h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                       ...
                       <h6 class="des"> First Name : <?php echo $dataArray['data'][$x]['vFirstName'];?> </h6>
                       
                       <h6 class="des">  Last Name  : <?php echo $dataArray['data'][$x]['vLastName'];?> </h6>
                       <h6 class="des"> Job Location : <?php echo $dataArray['data'][$x]['vJobLocation'];?> </h6>
                       <h6 class="des"> Mobile No : <?php echo $dataArray['data'][$x]['vMobile'];?> </h6>
                       <h6 class="des"> Prefer City : <?php echo $dataArray['data'][$x]['vPreferCity'];?> </h6>

                       <button class="click" onclick="location.href = 'contestdetails.php?id=<?php echo $id;?>&currentpage=1&challangename=<?php echo $chalange;?>';" id="search-button"> More Details </button>
