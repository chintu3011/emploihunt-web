    ...
    <div class="container-fluid bg-white p-0">
        ...
        <div class="container-fluid py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Jobseeker</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Jobseeker</li>
                    </ol>
                </nav>
            </div>
        </div>
...
$currentpage =$_GET['currentpage'];
        ...
        $url = "https://api.emploihunt.com/api/jobSeeker/get_applied_jobSeeker?jobId=$id&current_page=$currentpage";
        $ch = curl_init();
        ...
        ?><?php
         ...
         if($dataArray['status']=="500"){
            echo "There is no candidates for this post" ;
        } else{
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Jobseeker For this Post</h1>
                ...
                <div class="row g-4">
                    ...
                    <div class="cat-item rounded p-4">
                       ...
                       <h6 class="des"> First Name  : <?php echo $dataArray['data'][$x]['userJobPref']['vFirstName'];?> </h6>
                       <h6 class="des"> Last Name  : <?php echo $dataArray['data'][$x]['userJobPref']['vLastName'];?> </h6>
                       <h6 class="des"> Mobile  : <?php echo $dataArray['data'][$x]['userJobPref']['vMobile'];?> </h6>
                       <h6 class="des"> City  : <?php echo $dataArray['data'][$x]['userJobPref']['vCity'];?> </h6>
                       <h6 class="des"> WorkingMode  : <?php echo $dataArray['data'][$x]['userJobPref']['vWorkingMode'];?> </h6>
