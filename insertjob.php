        ...
        <div class="row g-4">
           <div class="col-lg-4">
            ...
            <option value="Market Development Specialist">Market Development Specialist</option>
                ...
                <div class="col-lg-4">
            <input type="text" id="company_name" class="form-control" name="vCompanyName"placeholder="Enter Company Name">

        </div>

        <div class="col-lg-4">
            <textarea name="tDes" id="" cols="30" rows="1" class="form-control" placeholder="Job Description"></textarea>
            </div>                       
                  
        <div class="col-lg-4">
               <input type="text" id="company_name" class="form-control" name="vJobLevel"placeholder="Job Level">
...
<div class="col-lg-4">
                        <input type="number" class="form-control" id="company_name" name="vExperience"placeholder="Reuired Experiences">
                    </div>
                    <div class="col-lg-4">
                        <input type="number" class="form-control" id="company_name" name="iNumberOfVacancy"placeholder="Reuired Experiences">
                    </div>
                        <!-- <textarea id="" name="vJobRoleResponsbility" rows="4" cols="10" placeholder="Job Roles & Responsbility"> -->
                            <div class="col-lg-4">
<textarea name="vJobRoleResponsbility" class="form-control" id="" cols="30" rows="1" placeholder="Job Roles & Responsbility"></textarea>
</div>                         
<div class="col-lg-4 ">
    <div class="d-flex">
                        <input type="text" class="form-control  name-input  clear" name="tTechnicalSkill"placeholder="Technical Skill" />
                        ...
                        <div class="col-lg-4">
                        <div class="d-flex">
                        <input type="text" class="form-control name-input1  clear" name="tSoftSkill"placeholder="Soft Skill" />
                        <button class="alert-btn1 btn btn-primary" type="button">
  ...
  <option value="<?php echo $dataArray['data'][$x]; ?> "> <?php echo $dataArray['data'][$x]; ?> </option>
            ...
            <div class="col-lg-4">
                <select name="vSalaryPackage"  class="form-control">  
                    <option value="vSalaryPackage">Salary Package</option>
                ...
                <div class="col-lg-4">
                    <select name="vWrokingMode"  class="form-control">  
                        <option value="vWrokingMode">Working Mode</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
            ...
            <input type="submit" value="Submit" class="btn btn-dark border-0">              
        </form>
                         </div>
